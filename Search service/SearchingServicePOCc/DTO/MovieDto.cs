...
using SearchingService_POC_c_.DTO.MovieDetails;
...
namespace SearchingService_POC_c_.Models
{
    public class MovieDto
    {
        ...
        public MovieCollectionDetails? MovieCollectionDetails { get; set; } 


        [JsonPropertyName("production_countries")]
        public List<MovieProductionCountry>? ProductionCompanies { get; set; }

        [JsonPropertyName("keywords")]
        public MovieKeywordWrapper MovieKeywords { get; set; } = new MovieKeywordWrapper();
